...
typedef void(^SRDelegateBlock)(id<DBZWebSocketDelegate> _Nullable delegate, SRDelegateAvailableMethods availableMethods);

@interface DBZDelegateController : NSObject

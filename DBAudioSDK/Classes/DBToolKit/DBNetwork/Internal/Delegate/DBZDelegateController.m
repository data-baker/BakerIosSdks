...
@interface DBZDelegateController ()
...
@implementation DBZDelegateController
...
{
    __block id<DBZWebSocketDelegate> delegate = nil;
...
{
    __block __strong id<DBZWebSocketDelegate> delegate = nil;

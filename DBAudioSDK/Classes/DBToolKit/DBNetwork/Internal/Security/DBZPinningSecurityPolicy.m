...
#import "DBZPinningSecurityPolicy.h"
...
@interface DBZPinningSecurityPolicy ()

@property (nonatomic, copy, readonly) NSArray *pinnedCertificates;

@end

@implementation DBZPinningSecurityPolicy
...
{
    DBZDebugLog(@"Pinned cert count: %d", self.pinnedCertificates.count);

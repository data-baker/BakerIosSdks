...
static NSString *_DBZHTTPConnectMessageHost(NSURL *url)
{
...
CFHTTPMessageRef DBZHTTPConnectMessageCreate(NSURLRequest *request,
                                            ...
                                            NSArray<NSString *> *_Nullable requestedProtocols)
{
    ...
    CFHTTPMessageSetHeaderFieldValue(message, CFSTR("Host"), (__bridge CFStringRef)_DBZHTTPConnectMessageHost(url));

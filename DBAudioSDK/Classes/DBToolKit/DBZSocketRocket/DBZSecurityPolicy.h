...
@interface DBZSecurityPolicy : NSObject

/**
 A default `DBZSecurityPolicy` implementation specifies socket security and
 validates the certificate chain.

 Use a subclass of `DBZSecurityPolicy` for more fine grained customization.
 */
...
/**
 ...
 you're free to override it in a subclass. See `DBZPinningSecurityPolicy.h` for
 an example.

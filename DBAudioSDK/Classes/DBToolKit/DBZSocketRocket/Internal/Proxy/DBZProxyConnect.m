...
@interface DBZProxyConnect() <NSStreamDelegate>
...
@implementation DBZProxyConnect
{
    DBZProxyConnectCompletion _completion;
...
- (void)openNetworkStreamWithCompletion:(DBZProxyConnectCompletion)completion
{
...
static NSTimeInterval const DBZProxyConnectWriteTimeout = 5.0;

- (void)_writeData:(NSData *)data
{
    const uint8_t * bytes = data.bytes;
    __block NSInteger timeout = (NSInteger)(DBZProxyConnectWriteTimeout * 1000000); // wait timeout before giving up
    __weak typeof(self) wself = self;

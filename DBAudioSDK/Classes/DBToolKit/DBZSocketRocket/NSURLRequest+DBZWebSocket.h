...
@interface NSURLRequest (DBZWebSocket)

/**
 An array of pinned `SecCertificateRef` SSL certificates that `DBZWebSocket` will use for validation.
 */
...
@interface NSMutableURLRequest (DBZWebSocket)
